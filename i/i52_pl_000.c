section "i52_pl_000"{
    ...
    Voice_PlayVoice("I5200000_W00000", #1, "");
    Message_Who(0);
    Message_MsgDisp("Manager", "Yes, this is Florist Anneri.");
    Message_Who(0);
    Message_MsgDisp("主人公", "I saw an e-mail about the job\napplications and decided to call...");
    Message_Who(0);
    Message_MsgDisp("　　　", "　　　　　　・\n　　　　　　・\n　　　　　　・");
    Voice_PlayVoice("I5200000_W00100", #1, "");
    Message_Who(0);
    Message_MsgDisp("Manager", "Then can I have you come in every\nTuesday and Thursday to work?");
    Message_Who(0);
    Message_MsgDisp("主人公", "Yes.\nI look forward to working with you.");
    Voice_PlayVoice("I5200000_W00200", #1, "");
    Message_Who(0);
    Message_MsgDisp("Manager", "Please come in then.\nI'm counting on you.");
    Parameter_InPl1Param(26, 5);
    Parameter_InByParam(5, 51, 1);
    SoundEffect_PlaySE(31, 127);
    Message_Who(0);
    Message_MsgDisp("主人公", "(So I have work at the florist every\nTuesday and Thursday.\nAlright, I'll do my best!)");
    Message_CloseMsg();
    Screen_WipeOut(2);
    Screen_ClearScreen();
    }
