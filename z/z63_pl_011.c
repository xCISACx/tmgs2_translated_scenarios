section "z63_pl_011"{
    ...
    if (Parameter_GetPl1Param(24) == 0){
        Message_MsgSel("Take an entrance exam for the university", "Take an employment exam instead", "Become a fashion designer");
        switch (Message_TextSelect()){
            ...
            Parameter_InPl1Param(15, Parameter_SinroJudge(20));
            Message_Who(0);
        ...
        Message_MsgSel("Take an employment exam", "Take the university entrance exam instead", "Become a fashion designer");
        switch (Message_TextSelect()){
            case 0:
            Message_Who(0);
