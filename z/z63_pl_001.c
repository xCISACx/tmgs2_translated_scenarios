section "z63_pl_001"{
    ...
    if (Parameter_GetPl1Param(24) == 0){
        Message_MsgSel("Take the university entrance exam", "Take the employment exam instead", "Find work at a Nei's music store");
        switch (Message_TextSelect()){
            ...
            Parameter_InPl1Param(15, Parameter_SinroJudge(22));
            Message_Who(0);
            Message_MsgDisp("主人公", "I can make use of the experience I\ngot at from work and take an exam!");
            Message_Who(0);
            Message_MsgDisp("　　　", "　　　　　　・\n　　　　　　・\n　　　　　　・");
            Message_Who(0);
        ...
        Message_MsgSel("Take an employment exam", "Take the university entrance exam instead", "Find work at a Nei's music store");
        switch (Message_TextSelect()){
            case 0:
            Message_Who(0);
