section "z63_pl_008"{
    ...
    if (Parameter_GetPl1Param(24) == 0){
        Message_MsgSel("Take the university entrance exam", "Take the employment exam instead", "Find work at a superb five-star company");
        switch (Message_TextSelect()){
            ...
            Parameter_InPl1Param(15, Parameter_SinroJudge(17));
            Message_Who(0);
        ...
        Message_MsgSel("Take an employment exam", "Take the university entrance exam instead", "Find work at a superb five-star company");
        switch (Message_TextSelect()){
            case 0:
            Message_Who(0);
