section "z63_pl_009"{
    ...
    if (Parameter_GetPl1Param(24) == 0){
        Message_MsgSel("Take the university entrance exam", "Take the employment exam instead", "Enter a top university of fine arts");
        switch (Message_TextSelect()){
            ...
            Parameter_InPl1Param(15, Parameter_SinroJudge(18));
            Message_Who(0);
        ...
        Message_MsgSel("Take an employment exam", "Take the university entrance exam instead", "Enter a top university of fine arts");
        switch (Message_TextSelect()){
            case 0:
            Message_Who(0);
