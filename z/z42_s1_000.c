section "z42_s1_000"{
    ...
    if (Parameter_GetCh1Param(1, 512) == 2){
        Voice_PlayVoice("Z4214000_N00200", #1, "");
        Message_Who(14);
        Message_MsgDisp("Yuu", "I met Saeki-san and when I spoke\nabout you, he said, \"Who's that?\"");
        }
    else if (Parameter_GetCh1Param(2, 512) == 2){
        Voice_PlayVoice("Z4214000_N00300", #1, "");
        Message_Who(14);
        Message_MsgDisp("Yuu", "I met Shiba-san and when I spoke\nabout you, he glared.");
        }
    else if (Parameter_GetCh1Param(3, 512) == 2){
        Voice_PlayVoice("Z4214000_N00400", #1, "");
        Message_Who(14);
        Message_MsgDisp("Yuu", "I met Hikami-san and when I spoke\nabout you, he trembled angrily.");
        }
    else if (Parameter_GetCh1Param(4, 512) == 2){
        Voice_PlayVoice("Z4214000_N00500", #1, "");
        Message_Who(14);
        Message_MsgDisp("Yuu", "I met Harry and when I spoke about\nyou, he said, \"That girl?\"");
        }
    else if (Parameter_GetCh1Param(5, 512) == 2){
        Voice_PlayVoice("Z4214000_N00600", #1, "");
        Message_Who(14);
        Message_MsgDisp("Yuu", "I met Chris-kun and when I spoke\nabout you, he said, \"Let's not go\nthere.\"");
        }
    else if (Parameter_GetCh1Param(6, 512) == 2){
        Voice_PlayVoice("Z4214000_N00700", #1, "");
        Message_Who(14);
        Message_MsgDisp("Yuu", "I met Amachi-san and when I spoke\nabout you, his face became fearful.");
        }
