section "k01_m8_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(23) == 0){
            Parameter_InCh1Param(8, 67, 0);
            Parameter_AddCh1Param(8, 61, 0);
            Parameter_AddCh1Param(8, 60, #1);
            }
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Silent Hill OST. 1 Rich", "Moisturizing Hand Cream.	1 Rich", "\"How To Clean Up\". 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(8, 67, 1);
            ...
            Message_MsgSel("Cafe-don Set with Lotus.	1 Rich", "Soft Hand Towel. 1 Rich", "\"How To Serve Customers\". 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(8, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Horror DVD Collection. 3 Rich", "Kitchen Cleaning Cloth. 1 Rich", "Shogi Magnet Set. 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(8, 67, 1);
