section "k01_m7_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(23) == 0){
            Parameter_InCh1Param(7, 67, 0);
            Parameter_AddCh1Param(7, 61, 0);
            Parameter_AddCh1Param(7, 60, #1);
            }
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Dictionary of Modern Slang. 1 Rich", "Manga Drawn in Class. 1 Rich", "Must Read! How to Stop Losing Things! 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(7, 67, 1);
            ...
            Message_MsgSel("Portrait Drawn in Class. 1 Rich", "Fragrance for Cat Sand. 1 Rich", "\"How to Become a Proper Adult\". 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(7, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Photo Collection: 101 Kittens. 3 Rich", "Newest Flea Removal Device. 1 Rich", "Massage Ticket made during class. 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(7, 67, 1);
