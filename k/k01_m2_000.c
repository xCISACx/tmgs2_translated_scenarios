section "k01_m2_000"{
    ...
    Message_MsgSel("Go and buy a present.", "Don't worry about it...");
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Low Resistant Sleep Easy Pillow 1 Rich", "Expander DX 1 Rich", "How to Smile DVD 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(2, 67, 1);
            ...
            Message_MsgSel("Silver Bookmark 1 Rich", "Ankle/Wrist Weights (5kg) 1 Rich", "Idol Photo Collection 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(2, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Mesh Undershirt 3 Rich", "Mini Exercise Ball 1 Rich", "Whitening Cream 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(2, 67, 1);
