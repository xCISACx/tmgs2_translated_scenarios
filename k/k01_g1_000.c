section "k01_g1_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(338) == 1){
            ...
            Message_MsgSel("Enka CD 		1 Rich", "Flower Bathpowder 		 1 Rich", "Sports Bag 		 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(10, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Gold Nail Polish 		 3 Rich", "Antique Cup 		 1 Rich", "Exam Reference Book 		 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(10, 67, 1);
