section "k01_m3_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(23) == 0){
            Parameter_InCh1Param(3, 67, 0);
            Parameter_AddCh1Param(3, 61, 0);
            Parameter_AddCh1Param(3, 60, #1);
            Parameter_AddCh1Param(3, 62, 2);
            }
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Saturn Mousepad 1 Rich", "Super Alloy Glasses Case 1 Rich", "\"How To Make Friends\" 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(3, 67, 1);
            ...
            Message_MsgSel("Top Quality Whistle 1 Rich", "\"Funny Joke Book\" 1 Rich", "Photo Book: Walk Under the Starry Sky 1 Rich");
            switch (Message_TextSelect()){
                case 2:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(3, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Meteorite Paperweight 3 Rich", "Light Bicycle Helmet 1 Rich", "\"Building a Buff Body!\" 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(3, 67, 1);
