section "k01_m6_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(23) == 0){
            Parameter_InCh1Param(6, 67, 0);
            Parameter_AddCh1Param(6, 61, 0);
            Parameter_AddCh1Param(6, 60, #1);
            Parameter_AddCh1Param(6, 62, 2);
            }
        if (Parameter_GetPl1Param(338) == 2){
            Message_MsgSel("Special Sweets Book 1 Rich", "Cross Strap 1 Rich", "Original Book of Horror Movies 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(6, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Silver Pocket Watch 3 Rich", "New Movie DVDs 1 Rich", "Fancy Knitting Book 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(6, 67, 1);
