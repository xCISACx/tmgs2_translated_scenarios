section "k01_m1_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Seashell Photo Frame 1 Rich", "Giant Monster Book 1 Rich", "Photo Collection of Surfers 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(1, 67, 1);
            ...
            Message_MsgSel("Single Flower Vase 1 Rich", "Classical Guitar CD 1 Rich", "Giant Monster Pajamas 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(1, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Glass Mermaid Figure 3 Rich", "Giant Monster Mug 1 Rich", "Pack of Canned Coffee 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(1, 67, 1);
