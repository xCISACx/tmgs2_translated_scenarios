section "k01_g3_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(23) == 0){
            Parameter_InCh1Param(12, 67, 0);
            Parameter_AddCh1Param(12, 60, #2);
            }
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Colored Nail Polish 1 Rich", "Cup and Saucer 1 Rich", "Standard Japanese Language Book 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(12, 67, 1);
            ...
            Message_MsgSel("Sweets Encyclopedia 1 Rich", "World's Masterpieces 1 Rich", "How to get Slim Legs 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(12, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Love Novels: Complete Works 3 Rich", "Comedy DVD 1 Rich", "Diet Supplements 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(12, 67, 1);
