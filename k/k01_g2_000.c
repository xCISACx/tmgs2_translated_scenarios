section "k01_g2_000"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetPl1Param(23) == 0){
            Parameter_InCh1Param(11, 67, 0);
            Parameter_AddCh1Param(11, 60, #2);
            }
        if (Parameter_GetPl1Param(338) == 1){
            Message_MsgSel("Raccoon Dog Mascot 1 Rich", "Animal Print Address Book 1 Rich", "Cat-Ear Headband 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(11, 67, 1);
            ...
            Message_MsgSel("Woodcraft Mongoose 1 Rich", "Animal Print Stationary Set 1 Rich", "Cat-Ear Headband 1 Rich");
            switch (Message_TextSelect()){
                case 0:
                if (Parameter_GetPl1Param(23) >= 1){
                    Parameter_InCh1Param(11, 67, 1);
            ...
            while (var0 < 1){
                if (Parameter_GetPl1Param(23) >= 3){
                    Message_MsgSel("Glass Rabbit Orchestra 3 Rich", "Animal Cosmetic Set 1 Rich", "Elephant-Ear Headband 1 Rich");
                    switch (Message_TextSelect()){
                        case 0:
                        Parameter_InCh1Param(11, 67, 1);
