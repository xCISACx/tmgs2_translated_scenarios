section "h49_pl_002"{
    ...
    if (System_GlobalWork(0, 1) == 0){
        if (Parameter_GetBkParam(4, 52) >= 200){
            ...
            Graphic_OpenAnim(51, 0);
            var1 = 1;
            }
        }
    else if (System_GlobalWork(0, 1) == 1){
        if (Parameter_GetBkParam(4, 52) >= 210){
            if (Parameter_GetCh1Param(2, 25) == 1){
                Background_Bg_GS2("BG_SCA13_?_0", 1, #1, 0);
                Screen_WipeIn(2);
                }
        ...
        if (Parameter_GetBkParam(4, 52) >= 240){
            if (Parameter_GetCh1Param(2, 25) == 1){
                Background_Bg_GS2("BG_SCA13_?_0", 1, #1, 0);
                Screen_WipeIn(2);
                }
        ...
        if (Parameter_GetBkParam(4, 52) >= 260){
            if (Parameter_GetCh1Param(2, 25) == 1){
                Background_Bg_GS2("BG_SCA13_?_0", 1, #1, 0);
                Screen_WipeIn(2);
                }
        ...
        if (Parameter_GetBkParam(4, 52) >= 290){
            if (Parameter_GetCh1Param(2, 25) == 1){
                Background_Bg_GS2("BG_SCA13_?_0", 1, #1, 0);
                Screen_WipeIn(2);
                }
            ...
            if (Parameter_GetBkParam(4, 52) >= 320){
                ...
                if (Parameter_GetCh1Param(2, 25) == 1){
                    ...
                    Message_Who(0);
                    Message_MsgDisp("主人公", "(We achieved our goal of dominating\nthe entire country in athletics!\nYay!)");
                    }
                Message_Who(0);
                Message_MsgDisp("主人公", "(We achieved our goal of dominating\nthe entire country!\nYay!)");
                Message_CloseMsg();
                Environment_StopME(1, 40);
                Parameter_InBkParam(4, 55, 1);
                var1 = 7;
                }
            else {
                if (Parameter_GetCh1Param(2, 25) == 1){
    ...
    switch (var1){
        ...
        Message_Who(0);
        Message_MsgDisp("主人公", "(We're the nation's 2nd best!\nIt was a little unfortunate, but\ncongratulations, you guys.)");
        Parameter_AddCh1Param(#1, 61, 5);
        break ;
        }
    Music_StopBGM(0, 40);
