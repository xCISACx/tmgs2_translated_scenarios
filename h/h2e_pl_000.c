section "h2e_pl_000"{
    ...
    Screen_WipeIn(2);
    if (Parameter_GetBkParam(2, 333) == 0){
        Message_Who(0);
        ...
        Message_MsgDisp("主人公", "T-This is!?");
        Message_Who(0);
        Message_MsgDisp("　　　", "(｛主人公姓名｝ obtained the\nstandard Lacrosse Club item, \"Sun\nCross\"!)");
        ...
        Message_MsgDisp("主人公", "T-This is!?");
        Message_Who(0);
        Message_MsgDisp("　　　", "(｛主人公姓名｝ obtained the\nstandard Lacrosse Club item, \"La\nCross\"!)");
        Parameter_AddPl1Param(19, 30);
        Parameter_AddPl1Param(18, 15);
        }
    Parameter_AddBkParam(2, 333, 1);
    Message_CloseMsg();
