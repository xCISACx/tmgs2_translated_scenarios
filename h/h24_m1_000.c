section "h24_m1_000"{
    if (Parameter_GetCh1Param(1, 130) <= 3){
        ...
        Voice_PlayVoice("H2401000_A00000", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "Yeah. I had a bit of free time...\nso I came to watch.... Focus, okay?");
        Message_Who(0);
        ...
        Voice_PlayVoice("H2401000_A00100", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "Yeah....\nI came here to see you do your best.");
        Character_ChFace(0, 0, 10);
        Character_BlinkStart(1, 2, (#1));
        Character_ChFace(0, 4, 1);
        Voice_PlayVoice("H2401000_A00200", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "I don't know the rules, though...\nAnyway, I...\nwill cheer for you, okay? ...\nDo your best.");
        Message_Who(0);
