section "h39_pl_001"{
    ...
    if (System_GlobalWork(0, 1) == 0){
        if (Parameter_GetBkParam(3, 52) >= 200){
            ...
            Background_Bg_GS2("BG_SCA31_?_0", 1, #1, 0);
            Screen_WipeIn(2);
            Graphic_OpenAnim(50, 0);
            var1 = 1;
            }
        }
    else if (System_GlobalWork(0, 1) == 1){
        if (Parameter_GetBkParam(3, 52) >= 210){
            Background_Bg_GS2("BG_SCA31_?_0", 1, #1, 0);
            Screen_WipeIn(2);
            Graphic_OpenAnim(50);
            Music_PlayBGM(0, "MN_K_01_004_000", 89, 40);
        ...
        if (Parameter_GetBkParam(3, 52) >= 240){
            Background_Bg_GS2("BG_SCA31_?_0", 1, #1, 0);
            Screen_WipeIn(2);
            Graphic_OpenAnim(50);
            Music_PlayBGM(0, "MN_K_01_004_000", 89, 40);
        ...
        if (Parameter_GetBkParam(3, 52) >= 260){
            Background_Bg_GS2("BG_SCA31_?_0", 1, #1, 0);
            Screen_WipeIn(2);
            Graphic_OpenAnim(50);
            Music_PlayBGM(0, "MN_K_01_004_000", 89, 40);
        ...
        if (Parameter_GetBkParam(3, 52) >= 290){
            Background_Bg_GS2("BG_SCA31_?_0", 1, #1, 0);
            Screen_WipeIn(2);
            Graphic_OpenAnim(50);
            Music_PlayBGM(0, "MN_K_01_004_000", 89, 40);
