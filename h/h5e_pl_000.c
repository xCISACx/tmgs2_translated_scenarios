section "h5e_pl_000"{
    ...
    Screen_WipeIn(2);
    if (Parameter_GetBkParam(5, 333) == 0){
        Message_Who(0);
        ...
        Message_MsgDisp("主人公", "T-This is!?");
        Message_Who(0);
        Message_MsgDisp("　　　", "(｛主人公姓名｝ obtained the\nsecret Art Club item, \"Pastels\"!)");
        Parameter_AddPl1Param(17, 20);
        ...
        Message_MsgDisp("主人公", "T-This is!?");
        Message_Who(0);
        Message_MsgDisp("　　　", "(｛主人公姓名｝ obtained the\nlegendary Art Club item, \"Hikasso's\nPaint\"!)");
        Parameter_AddPl1Param(17, 30);
        Parameter_AddPl1Param(16, 15);
        }
    Message_CloseMsg();
    Parameter_AddBkParam(5, 333, 1);
