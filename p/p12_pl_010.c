section "p12_pl_010"{
    ...
    if (Parameter_ChkSpEvent("D01", "M1", 3) == 1){
        System_Call_GS2("D01", "M1", 3);
        System_Call_GS2("P13", "S1", 0);
        }
    else {
        switch (var0){
            case 0:
            ...
            break ;
            case 1:
            System_Call_GS2("P13", "M1", 0);
            break ;
            case 2:
            System_Call_GS2("P13", "M2", 0);
            break ;
            case 3:
            System_Call_GS2("P13", "M3", 0);
            break ;
            case 4:
            System_Call_GS2("P13", "M4", 0);
            break ;
            case 5:
            System_Call_GS2("P13", "M5", 0);
            break ;
            case 7:
            System_Call_GS2("P13", "M7", 0);
            break ;
            case 8:
            System_Call_GS2("P13", "M8", 0);
            break ;
            }
        }
    System_Call_GS2("P15", "PL", 0);
    }
