section "p72_pl_010"{
    ...
    switch (var3){
        case 1:
        if (Parameter_GetCh1Param(1, 328) != 2){
    ...
    switch (var0){
        case 0:
        System_Call_GS2("P73", "S1", 0);
        break ;
        case 1:
        System_Call_GS2("P73", "M1", 0);
        break ;
        case 2:
        System_Call_GS2("P73", "M2", 0);
        break ;
        case 3:
        System_Call_GS2("P73", "M3", 0);
        break ;
        case 4:
        System_Call_GS2("P73", "M4", 0);
        break ;
        case 5:
        System_Call_GS2("P73", "M5", 0);
        break ;
        case 6:
        System_Call_GS2("P73", "M6", 0);
        break ;
        case 7:
        System_Call_GS2("P73", "M7", 0);
        break ;
        case 8:
        System_Call_GS2("P73", "M8", 0);
        break ;
        }
    System_Call_GS2("P75", "PL", 0);
    }
