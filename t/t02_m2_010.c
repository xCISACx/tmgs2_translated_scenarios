section "t02_m2_010"{
    ...
    switch (Message_TextSelect()){
        ...
        Message_CloseMsg();
        Screen_WipeOut(2);
        Still_Event("EV_02_23", #1, 0, 120);
        Screen_WipeIn(2);
        System_Wait(120);
        Still_Event("EV_02_23", #1, 1, 120, 0, 1);
        System_Wait(120);
        Screen_WipeOut(3);
        System_GlobalWork(3, 0, 20);
        Parameter_InCh1Param(2, 305, 3);
        break ;
        case 1:
        Music_StopBGM(0, 40);
        Message_Who(0);
        ...
        Voice_PlayVoice("T0202010_B01600", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "... At the very end... I still lost.");
        Character_ChFace(0, 2, 5);
        Character_BlinkStart(2, 3, (#1));
        Character_ChFace(0, 3, 2);
        Music_PlayBGM(0, "MN_C_02_001_D00", 127, 40);
        Voice_PlayVoice("T0202010_B01700", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "If it were a baseball game, I'd be\nable to try harder so I can win the\nnext one.");
        Message_Who(0);
        Message_MsgDisp("主人公", "｛Shiba＊＊｝...");
        Character_ChFace(0, 2, 2);
        Character_ChFace(0, 3, 3);
        Voice_PlayVoice("T0202010_B01800", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "... I'm kidding.");
        Character_BlinkStart(2, 0, (#1));
        Voice_PlayVoice("T0202010_B01900", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "Just telling you is enough for me.");
        Character_ChFace(0, 0, 10);
        Character_BlinkStart(2, 3, (#1));
        Voice_PlayVoice("T0202010_B02000", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "I've got no regrets....\nI really think that way.");
        Character_ChFace(0, 0, 10);
        Voice_PlayVoice("T0202010_B02100", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "It's about time I go.");
        Message_Who(0);
        Message_MsgDisp("主人公", "｛Shiba＊＊｝...");
        Character_ChFace(0, 2, 0);
        Character_BlinkStart(2, 2, (#1));
        Voice_PlayVoice("T0202010_B02200", #1, "");
        Message_Who(2);
