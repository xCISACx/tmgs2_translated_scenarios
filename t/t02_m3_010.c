section "t02_m3_010"{
    ...
    System_Wait(#60);
    Message_MsgSel("Of course...!", "I'm sorry...");
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("T0203010_C01700", #1, "");
        Message_Who(3);
        Message_MsgDisp("Hikami", "...... I see. I lost the election.");
        Message_Who(0);
        Message_MsgDisp("主人公", "......");
        Character_ChFace(0, 2, 5);
        Character_BlinkStart(3, 2, (#1));
        Character_ChFace(0, 3, 3);
        Voice_PlayVoice("T0203010_C01800", #1, "");
        Message_Who(3);
        Message_MsgDisp("Hikami", "So I've graduated from two things\ntoday: School and from the days I\nspend thinking about you.");
        Character_ChFace(0, 0, 9);
        Voice_PlayVoice("T0203010_C01900", #1, "");
        Message_Who(3);
        Message_MsgDisp("Hikami", "\"A bird does not foul the nest it is\nabout to leave\".\nThe graduates will make their exit.");
        Message_Who(0);
        Message_MsgDisp("主人公", "｛Hikami＊＊｝...");
        Character_ChFace(0, 0, 10);
        Character_ChFace(0, 2, 5);
        Voice_PlayVoice("T0203010_C02000", #1, "");
        Message_Who(3);
