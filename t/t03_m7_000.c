section "t03_m7_000"{
    ...
    else if (System_GlobalWork(3, 1) == 78){
    ...
    if ((System_GlobalWork(3, 1) == 70) || (System_GlobalWork(3, 1) == 78)){
        Message_Epilog_Text(17, 0);
        Message_DispMsg(0);
        Message_Who(0);
        Message_MsgDisp("　　　", "　　　");
        Message_DispMsg(1);
        System_Call_GS2("T03", "PL", 17);
        }
    if ((System_GlobalWork(3, 1) == 70) || (System_GlobalWork(3, 1) == 78)){
        Message_Epilog_Text(17, 0);
        Message_DispMsg(0);
