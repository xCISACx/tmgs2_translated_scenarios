section "t03_m4_000"{
    ...
    else if (System_GlobalWork(3, 1) == 48){
    ...
    Message_DispMsg(1);
    if ((System_GlobalWork(3, 1) == 40) || (System_GlobalWork(3, 1) == 48)){
        Message_Epilog_Text(17, 0);
        Message_DispMsg(0);
        Message_Who(0);
        Message_MsgDisp("　　　", "　　　");
