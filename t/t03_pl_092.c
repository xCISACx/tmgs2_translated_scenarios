section "t03_pl_092"{
    ...
    Message_Who(0);
    Message_MsgDisp("　　　", "Tarou-kun is about to be in his 2nd\nyear.\nWe have dates on campus.");
    ...
    Message_Who(0);
    Message_MsgDisp("　　　", "He introduced me to the club he's\nin, saying \"Isn't my girl cute?\"...\nI was glad, but everyone looked\nshocked.");
    Message_Epilog_Text(10, 0);
    Message_Who(0);
    Message_MsgDisp("　　　", "He invited me over to his place,\nsince his family will be playing as\na string quartet.\nI'm a little nervous.");
    }
