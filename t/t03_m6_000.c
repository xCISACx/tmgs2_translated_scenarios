section "t03_m6_000"{
    ...
    else if (System_GlobalWork(3, 1) == 68){
    ...
    if ((System_GlobalWork(3, 1) == 60) || (System_GlobalWork(3, 1) == 68)){
        Message_Epilog_Text(17, 0);
        Message_DispMsg(0);
        Message_Who(0);
        Message_MsgDisp("　　　", "　　　");
        Message_DispMsg(1);
        System_Call_GS2("T03", "PL", 16);
        }
    if ((System_GlobalWork(3, 1) == 60) || (System_GlobalWork(3, 1) == 68)){
        Message_Epilog_Text(17, 0);
        Message_DispMsg(0);
