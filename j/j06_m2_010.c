section "j06_m2_010"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetCh1Param(2, 130) == 3){
            ...
            Voice_PlayVoice("J0602010_B00200", #1, "");
            Message_Who(2);
            Message_MsgDisp("Shiba", "... Good.");
            Message_Who(0);
            Message_MsgDisp("主人公", "Then is it alright if we meet at the\n｛待ち合わせ場所｝ next Sunday?");
            Voice_PlayVoice("J0602010_B00300", #1, "");
            Message_Who(2);
        ...
        case 1:
        if (Parameter_GetCh1Param(2, 130) == 3){
            Voice_PlayVoice("J0602010_B00400", #1, "");
            Message_Who(2);
            ...
            Voice_PlayVoice("J0602010_B00500", #1, "");
            Message_Who(2);
            Message_MsgDisp("Shiba", "I see... Okay.\nTell me if there's somewhere you\nwanna go next time.");
            Voice_PlayVoice("J0602010_B00600", #1, "");
            Message_Who(2);
