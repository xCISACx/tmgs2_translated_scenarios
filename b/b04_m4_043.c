section "b04_m4_043"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0404043_D00000", #1, "");
        Message_Who(4);
        ...
        Message_PauseSkinship();
        Voice_PlayVoice("B0404043_D00100", #1, "");
        Message_Who(4);
        Message_MsgDisp("Hariya", "Yeah, never expected it to be that\nfun.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
        ...
        Voice_PlayVoice("B0404043_D00200", #1, "");
        Message_Who(4);
