section "b04_m1_042"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0401042_A00000", #1, "");
        Message_Who(1);
        ...
        Voice_PlayVoice("B0401042_A00100", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "Well, apparently it's based on a\nweird kind of game, but I don't know\nmuch about it...");
        ...
        Message_PauseSkinship();
        Voice_PlayVoice("B0401042_A00200", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "You're right.\nFrom the start, they said it was the\nmost beautiful and powerful event,\nbut I don't see that...");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
