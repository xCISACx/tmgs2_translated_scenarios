section "b04_m2_182"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0402182_B00000", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "Yeah. I could watch it once more.");
        ...
        Message_PauseSkinship();
        Voice_PlayVoice("B0402182_B00100", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "\"So-so\", huh. I...\nreally enjoyed myself.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
        ...
        Voice_PlayVoice("B0402182_B00200", #1, "");
        Message_Who(2);
        Message_MsgDisp("Shiba", "Then our movie preferences don't\nmatch.");
        Message_Who(0);
