section "b04_m1_045"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0401045_A00000", #1, "");
        Message_Who(1);
        ...
        Voice_PlayVoice("B0401045_A00100", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "Really?\nI wonder if that kinda event is\npopular...");
        ...
        Message_PauseSkinship();
        Voice_PlayVoice("B0401045_A00200", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "I thought so too.\nPeople good at singing are kind of\ncocky.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
