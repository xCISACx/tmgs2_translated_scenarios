section "b04_m4_187"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0404187_D00000", #1, "");
        Message_Who(4);
        Message_MsgDisp("Hariya", "...\nThis is how I spend my precious\ntime.\n*Sigh*...");
        Message_Who(0);
        ...
        Voice_PlayVoice("B0404187_D00100", #1, "");
        Message_Who(4);
        Message_MsgDisp("Hariya", "... You're praising it too much.\nI should say this bluntly.\nIt's boring.");
        Message_Who(0);
        ...
        Voice_PlayVoice("B0404187_D00200", #1, "");
        Message_Who(4);
        Message_MsgDisp("Hariya", "You do have quite a good judgement.\nThat one was no good.");
