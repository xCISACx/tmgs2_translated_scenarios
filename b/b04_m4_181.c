section "b04_m4_181"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0404181_D00000", #1, "");
        Message_Who(4);
        Message_MsgDisp("Hariya", "Where and which part of it was the\nbest?\nSpeak! ...\nJust forget it, I don't want to hear\nit!");
        Message_Who(0);
        ...
        Voice_PlayVoice("B0404181_D00100", #1, "");
        Message_Who(4);
        ...
        Voice_PlayVoice("B0404181_D00200", #1, "");
        Message_Who(4);
        Message_MsgDisp("Hariya", "I couldn't care less. Argh.\nAnyway, erase it from my memory,\nquickly～!");
