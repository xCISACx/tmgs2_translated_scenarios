section "b04_m6_045"{
    ...
    switch (Message_TextSelect()){
        ...
        if (Parameter_GetCh1Param(6, 130) <= 2){
            ...
            Message_Who(6);
            Message_MsgDisp("Amachi", "Yes. I was crazy about it!");
            ...
            Message_Who(6);
            Message_MsgDisp("Amachi", "I agree with you! It was exciting!");
            Message_ResumeSkinship();
            Message_SkinshipSet(1);
            Message_Who(0);
            Message_MsgDisp("主人公", "(Yeah! I made a good impression.)");
        ...
        if (Parameter_GetCh1Param(6, 130) <= 2){
            ...
            Message_Who(6);
            Message_MsgDisp("Amachi", "It was quite exciting.\nI was able to enjoy it, and it was\ngood we came.");
            Message_ResumeSkinship();
            Message_SkinshipSet(1);
            Message_Who(0);
            Message_MsgDisp("主人公", "(Uhh, I made an okay impression.)");
