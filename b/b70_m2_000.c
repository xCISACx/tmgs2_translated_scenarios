section "b70_m2_000"{
    ...
    if ((var0 == 4 && System_GlobalWork(23, 1) == 2)){
        }
        ...
        switch (var0){
            case 1:
            Message_Who(0);
            Message_MsgDisp("主人公", "It says: \"Don't you get bored when\nyou're with me?\"");
            Message_Who(0);
            Message_MsgDisp("主人公", "(Yes!\nI feel like I've gotten a little\ncloser to ｛Shiba＊＊｝\ntoday!)");
            break ;
            case 2:
            Message_Who(0);
            Message_MsgDisp("主人公", "It says: \"It was fun. Later.\"");
            Message_Who(0);
            Message_MsgDisp("主人公", "(Thank gosh!\nI feel like I've gotten a lot closer\nto ｛Shiba＊＊｝ today!)");
            break ;
            case 3:
            Message_Who(0);
            Message_MsgDisp("主人公", "It says: \"Why do you touch?\nWell, it doesn't feel bad.\"");
            Message_Who(0);
            Message_MsgDisp("主人公", "(Yay!\nIt seems like ｛Shiba＊＊｝\nis really happy about how things\nwent today!)");
            break ;
            case 4:
            Message_Who(0);
            Message_MsgDisp("主人公", "It says: \"After we part ways, I\nrecall the sensation of your hands.\nWhat should I do?\"");
            Message_Who(0);
