section "b04_m1_184"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0401184_A00000", #1, "");
        Message_Who(1);
        ...
        Voice_PlayVoice("B0401184_A00100", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "Well.\nIt wasn't something I'd call the\nworst.");
        ...
        Character_ChFace(1, 3, 4);
        Message_PauseSkinship();
        Voice_PlayVoice("B0401184_A00200", #1, "");
        Message_Who(1);
        Message_MsgDisp("Saeki", "Yeah...\nWhen they were saying complex\nthings, I felt like they weren't\nreally saying anything at all.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
