section "b04_m5_181"{
    ...
    Screen_WipeIn(2);
    Message_MsgSel("That movie was the best!", "That move was so-so.", "That movie was disappointing.");
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0405181_E00000", #1, "");
        Message_Who(5);
        Message_MsgDisp("Chris", "I feel like I've seen some of the\nscenes before in another movie, so I\nwasn't able to enjoy it...");
        Message_Who(0);
        ...
        Voice_PlayVoice("B0405181_E00100", #1, "");
        Message_Who(5);
        ...
        Character_ChFace(1, 3, 3);
        Message_PauseSkinship();
        Voice_PlayVoice("B0405181_E00200", #1, "");
        Message_Who(5);
        Message_MsgDisp("Chris", "It's a solid B. I don't hate it.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
