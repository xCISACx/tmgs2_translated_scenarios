section "b04_m5_043"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0405043_E00000", #1, "");
        Message_Who(5);
        Message_MsgDisp("Chris", "Yeah.\nI wonder what kind of devices they\nused.\nI want to watch it, again!");
        ...
        Character_ChFace(1, 3, 0);
        Message_PauseSkinship();
        Voice_PlayVoice("B0405043_E00100", #1, "");
        Message_Who(5);
        Message_MsgDisp("Chris", "Yeah.\nI was absorbed in the performance.\nIt was interesting～.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
        ...
        Voice_PlayVoice("B0405043_E00200", #1, "");
        Message_Who(5);
        Message_MsgDisp("Chris", "Disappointing...\nRight, you were the one who was\ndisappointing...");
        Message_Who(0);
