section "b04_m5_041"{
    ...
    switch (Message_TextSelect()){
        ...
        Voice_PlayVoice("B0405041_E00000", #1, "");
        Message_Who(5);
        ...
        Character_ChFace(1, 3, 0);
        Message_PauseSkinship();
        Voice_PlayVoice("B0405041_E00100", #1, "");
        Message_Who(5);
        Message_MsgDisp("Chris", "Meaning you were able to enjoy it at\nleast a bit?\nThat's fine, then.");
        Message_ResumeSkinship();
        Message_SkinshipSet(1);
        Message_Who(0);
        ...
        Voice_PlayVoice("B0405041_E00200", #1, "");
        Message_Who(5);
